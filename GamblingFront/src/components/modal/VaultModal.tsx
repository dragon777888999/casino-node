...
const VaultModal: React.FC<DispalyGameInfoModalProps> = ({
  showModal,
  ...
  return (
    ...
    >
      <div
        ...
        style={{ fontSize: "13px", zIndex: "1000" }}
      >
          ...
          >
            ...
            >
              <div className="flex gap-3">
                ...
                <h2 style={{ fontSize: "18px", fontWeight: "600" }}>Vault</h2>
                <button
            ...
            <div className="info-content">
              <p>The vault keeps your funds safe for later use.</p>
            </div>
              ...
              >
                ...
                >
                  <div className="input-content mt-2">
                    ...
                    <div
                      className="input-inline-vault-container my-1 items-center px-2"
                      style={{ backgroundColor: "#171f38" }}
                    >
                      <Image
                ...
                >
                  <div className="my-3 flex justify-between">
                    <div className="flex">
                      ...
                      <label style={{ fontSize: "13px", marginLeft: "5px  " }}>
                        Vault Balance
                      </label>
                    </div>
                  ...
                  <div className="input-content mt-2">
                    ...
                    <div className="input-inline-vault-container my-1 items-center px-2">
                      <Image
                        src={currencyDir} // Adjust path and naming if needed
                        width={20}
                        height={20}
