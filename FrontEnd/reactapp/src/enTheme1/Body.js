    ...
    return (
        <section>
            <section className="banner">
                <img id="banner1" src="/enTheme1/images/banner.png" alt="Banner" />
                <img id="banner2" src="/enTheme1/images/banner2.png" alt="Banner" />
            </section>
                ...
                <div className="game-grid">
                    {listGames.map((gameCode, index) => (
                        <div className="gameCode" key={index}>
                            <img src={`/enTheme1/images/${gameCode}.png`} onclick="launchGame('Spribe_Mini','@gameCode')" />
                        </div>
                    ))}
                </div>
                {/* <script>
