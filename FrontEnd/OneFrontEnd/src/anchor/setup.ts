...
export const entryUrl = "craftystake.online";
export const network = "https://api.devnet.solana.com";
export const endDate = 1721001600;
export const startDate = 1719273600;
export const programId = new PublicKey(
  "4HBYycKhytiviTGmCJX5dMKZuGBVJWakc9AyKH8PsvDd"
);
export const tokenMintKey = new PublicKey(
  "KC3DVPP9gNe9pc8dohAehnrj392cPpjdKzF5iAro3bT"
);
