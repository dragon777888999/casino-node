...
const entryPage = () => {
    ...
    return (
        ...
        <div className="entry-screen" id="entry_screen" onScroll={onScrollEntryScreen}>
...
export default function EntryScreen({ onContinue }) {
    return (
        <div className="page trade_page">
            <HelmetManager
                title="About"
                description="Discover: Your Guide to Bitcoin Prediction Games, Earning Cryptocurrency, and Memecoins through Airdrops."
                keywords="about, Bitcoin prediction games, earning cryptocurrency, memecoins, airdrops, UpvsDown"
                canonical="/about"
            />
