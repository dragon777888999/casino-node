...
const GeneralStats = forwardRef((props, ref) => {
    ...
    return (
        ...
        <section className="entry-section white stats">
            ...
            <div className="main-flex">
                ...
                <div className="caption web-only block">
                    <span>PAID SO FAR AND WIN RATIO</span>
                </div>

                <div className="caption mobile-only block">
                    <span>PAID<br/>SO FAR AND<br/>WIN RATIO</span>
                </div>

                    <div className="stats-data-flex" ref={statsDataRef}>

                        <div className="win-box win-ratio-24">
                            <div className="top-text"><span>Last 24H</span></div>
                            <div className="middle-text"><span>WIN RATIO</span></div>
                        ...
                        <div className="win-box wins-paid-24">
                            <div className="top-text"><span>Last 24H</span></div>
                            <div className="middle-text"><span>WINS PAID</span></div>
                            <div className="bottom-text">
                                <span>
                                    {statsData &&<AnimatedNumber
                                        component="text"
                        ...
                        <div className="win-box wins-paid-all">
                            <div className="top-text"><span>All Time</span></div>
                            <div className="middle-text"><span>WINS PAID</span></div>
                            <div className="bottom-text">
                                <span>
                                    {statsData &&<AnimatedNumber
