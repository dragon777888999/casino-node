...
import LeaderboardTableHeader from './LeaderBoard/LeaderboardTableHeader';
import LeaderboardTableRow from './LeaderBoard/LeaderboardTableRow';
...
export default function LeaderboardPage() {
	...
	const getLeaderboardData = async (type, partnerRef, isDemoModeActive) => {
		...
		try {
			const response = await leaderboard.getLeaderboard(partnerRef, ranges?.from, ranges?.to, isDemoModeActive);
