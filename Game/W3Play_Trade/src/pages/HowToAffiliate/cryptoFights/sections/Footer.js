...
const Footer = () => {
    ...
    const onClickFooterArrow = () => {
        document.querySelector('section.social-friends').scrollIntoView({block: 'start', behavior: 'smooth'});
    };
    ...
    return (
        ...
        <>
            ...
            <section className="footer web-only block">
            ...
            <section className="footer mobile-only block">
