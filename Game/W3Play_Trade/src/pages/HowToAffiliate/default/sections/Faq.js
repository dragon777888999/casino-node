...
const Faq = () => {
    ...
    const [activeTab, setActiveTab] = useState(APP.state.get('special_tab') || 'affiliate');
    ...
    return (
        ...
        <section className="faq dark seperator">

            <div className="main-flex">

                <div className="caption stripe">
                    <span>{APP.term('baa_faq')}</span>
                </div>
                ...
                <div className="faq-wrap">
                    ...
                    <div className="faq-content-wrap" ref={wrap_ref}>
