...
const CryptoWeb: React.FC = () => {
    ...
    console.log(APP.state.get('wallet_address'), wallet_address, 'wallet outside openIframe func.')

    // open iframe popup by btn clicked
    function openIframe(coinSymbol: string, wallet_address: string) {
        console.log(wallet_address, 'wallet inside openIframe func.')
    ...
    return (
        <div className="tt_content crypto_content">
