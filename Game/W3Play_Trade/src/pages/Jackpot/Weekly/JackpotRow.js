...
const JackpotRow = ({ /*setActiveRowId,*/ activeRowId, ownTrades, progressing, participantsCount, threshold, prize, poolNumber, participantsList }) => {
    ...
    // ** Currently there is no players's list => so req no needed
    ...
    return (
        ...
        <div ref={rowEl} className="row-wrap">

            {/* ##### ROW TOP ##### */}
            <div className={rowTopClasses}>

                {completed && <div className="participating-message"><span>{APP.term('weekly_row_participating_msg')}</span></div>}
                ...
                <div className="condition">
                    ...
                    <div className="weekly-trades">
                        ...
                        <div className="text"><span>{APP.term('weekly_row_header')}<br />{APP.term('weekly_row_header_trades')}</span></div>
                    </div>
                ...
                <div className="players">
                    <div className="title"><span>{APP.term('weekly_row_players')}</span></div>
                ...
                <div className="prize">
                    <div className="title"><span>{APP.term('weekly_row_prize')}</span></div>
                    <div className="amount">
                        <Symbol />
                        <span>
                            <AnimatdPrize prize={prize} />
                            {/* {parseFloat(prize).toFixed(state.jackpot_fractional_digits)} */}
                        </span>
                    </div>
                </div>
            ...
            <div className="expansion" ref={expEl} onTransitionEnd={onExpandTransitionEnd}>
                ...
                <div className="expansion-header" ref={expHeadEl}>
                    ...
                    <div className="player"><span>{APP.term('weekly_row_player')}</span></div>
                    <div className="wallet"><span>{APP.term('weekly_row_wallet')}</span></div>
                    <div className="cards"><span>{APP.term('weekly_row_participation_cards')}</span></div>
                </div>
